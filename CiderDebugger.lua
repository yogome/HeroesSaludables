...
local CiderRunMode = {};CiderRunMode.runmode = 'DEBUG';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/CetoBasilius/Library/Application Support/luaglider2/dev";local SOCKET_PORT=34429;local GLIDER_MAIN_FOLDER= "/Users/CetoBasilius/Documents/Projects/HeroesSaludables";local useNativePrint= false;local snapshotInterval= 5;local snapshotInterval= 5;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
