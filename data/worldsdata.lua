...
local worldsData = {
	...
	[2] = {
		...
		[7] = {
			...
			asteroids = {
				[1] = {
					lineStart = {x = 1950, y = 0},
					lineEnd = {x = 1300, y = 300},
					easingX = easing.inSine,
					easingY = easing.outSine,
				},
				[2] = {
					lineStart = {x = 1950, y = 900},
					lineEnd = {x = 1300, y = 600},
					easingX = easing.inSine,
					easingY = easing.outSine,
				},
				[3] = {
		...
		[8] = {
			...
			asteroids = {
				[1] = {
					lineStart = {x = -1800, y = -1000},
					lineEnd = {x = -1400, y = -550},
					easingX = easing.outSine,
					easingY = easing.inSine,
				},
				[2] = {
					lineStart = {x = -800, y = -1000},
					lineEnd = {x = -1200, y = -550},
					easingX = easing.outSine,
					easingY = easing.inSine,
				},
		...
		[11] = {
			...
			asteroids = {
				[1] = {
					lineStart = {x = 800, y = -300},
					lineEnd = {x = 0, y = -800},
				},
				[2] = {
					lineStart = {x = 0, y = -800},
					lineEnd = {x = -1200, y = -100},
				},
				[3] = {
					lineStart = {x = -1200, y = -100},
					lineEnd = {x = 0, y = 700},
				},
				[4] = {
					lineStart = {x = 0, y = 700},
		...
		[13] = {
			...
			enemySpawnData = {
				...
				{
					type = "shooter",
					spawnPoint = { x = -1100, y = 0},
					angle = 315
				},
				{
					type = "shooter",
					spawnPoint = { x = 500, y = -50},
					angle = 315
				},
				{
					type = "shooter",
			...
			asteroids = {
				...
				[2] = {
					lineStart = {x = 1700, y = -1000},
					lineEnd = {x = -400, y = 500},
				},
				[3] = {
					lineStart = {x = -200, y = 1000},
					lineEnd = {x = 1300, y = 100},
				},
			},
		},
		--Level 14
		[14] = {
			...
			enemySpawnData = {
				...
				{
					type = "shooter",
					spawnPoint = { x = -1900, y = -500},
					angle = 0
				},
				{
					type = "shooter",
					spawnPoint = { x = 1900, y = -400},
					angle = 180
				},
				{
					type = "shooter",
					spawnPoint = { x = 1900, y = -800},
					angle = 180
				},
			},
			obstacle = {
